  ...
  return (
    ...
    >
      <div className="bo-menuV2Main" data-slot="menu-summary-main">
        ...
        <div className="bo-menuV2Row bo-menuV2Row--status" data-slot="menu-summary-status-row">
        ...
        <div className="bo-menuV2Row bo-menuV2Row--footer" data-slot="menu-summary-footer-row">
