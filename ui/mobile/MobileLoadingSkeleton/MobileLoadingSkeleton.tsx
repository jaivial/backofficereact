      ...
      <div className={["flex flex-col gap-3", className].join(" ")} data-ui={dataUi} aria-busy="true" aria-label="Cargando...">
        {Array.from({ length: count }).map((_, i) => (
          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-2" data-slot="mobileLoadingSkeleton-gap-2">
  ...
  return (
    <div className={["flex flex-col gap-3", className].join(" ")} data-ui={dataUi} aria-busy="true" aria-label="Cargando...">
      {Array.from({ length: count }).map((_, i) => (
        ...
        >
          <div className="flex items-center justify-between" data-slot="mobileLoadingSkeleton-justify-between">
