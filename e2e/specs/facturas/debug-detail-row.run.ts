  ...
  try {
    ...
    const result = await page.evaluate(() => {
      ...
      return {
        ...
        label: { top: lr.top, left: lr.left, width: lr.width, height: lr.height },
        value: { top: vr.top, left: vr.left, width: vr.width, height: vr.height },
        rowRect: first.getBoundingClientRect(),
      };
    });
