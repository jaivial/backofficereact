...
export type BOSection = "campanas" | "anuncios" | "qr" | "reservas" | "menus" | "comida" | "stock" | "pos" | "ajustes" | "miembros" | "fichaje" | "horarios" | "facturas" | "reportes" | "estadisticas" | "estado_cuenta" | "website" | "site-builder" | "plataforma";

export const ROLE_SECTION_ACCESS: Record<string, BOSection[]> = {
  root: ["reservas", "menus", "comida", "stock", "pos", "ajustes", "miembros", "horarios", "fichaje", "facturas", "reportes", "estadisticas", "estado_cuenta", "website", "site-builder", "plataforma", "campanas", "anuncios", "qr"],
  admin: ["reservas", "menus", "comida", "stock", "pos", "ajustes", "miembros", "horarios", "fichaje", "facturas", "reportes", "estadisticas", "estado_cuenta", "website", "site-builder", "campanas", "anuncios", "qr"],
...
function isSection(value: string): value is BOSection {
  return value === "campanas" || value === "anuncios" || value === "qr" || value === "reservas" || value === "menus" || value === "comida" || value === "stock" || value === "pos" || value === "ajustes" || value === "website" || value === "site-builder" || value === "miembros" || value === "fichaje" || value === "horarios" || value === "facturas" || value === "reportes" || value === "estadisticas" || value === "estado_cuenta" || value === "plataforma";
}
