  ...
  return (
    <div className="bo-stage" data-slot="@token-stage">
      <div className="bo-window bo-window--auth bo-onboardingWindow" data-slot="@token-onboardingWindow">
        <div className="bo-authCard" role="main" aria-label="Invitación" data-slot="@token-invitaci-n">
          {loading ? (
            ...
            <>
              ...
              <div className="bo-title" data-slot="@token-title">No se pudo validar la invitación</div>
              <div className="bo-authSub" data-slot="@token-authSub">{error}</div>
              <button className="bo-btn bo-btn--ghost" type="button" data-testid="invitacion-page-login-link" onClick={() => (window.location.href = "/login")}>
                Ir a login
              </button>
            </>
          ) : (
            <>
              ...
              <div className="bo-title" data-slot="@token-title">Bienvenido{invitation?.firstName ? `, ${invitation.firstName}` : ""}</div>
              <div className="bo-authSub" data-slot="@token-authSub">Tu invitación está activa. Pulsa empezar para completar tu onboarding.</div>

              <button className="bo-btn bo-btn--primary" type="button" data-testid="invitacion-page-empezar" disabled={starting} onClick={onStart}>
