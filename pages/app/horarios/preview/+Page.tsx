      ...
      <div className="rounded-xl border border-border bg-card-2">
        <div className="flex items-center justify-between p-4 pb-0">
          <div>
            ...
            <div className="text-xs text-text-muted mt-0.5">Estado en vivo para la fecha seleccionada.</div>
          </div>
                  ...
                  {liveMembers.map((member) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-xs text-text-muted mt-2">{scheduleLabel(schedule)}</div>
                      </article>
                    );
                  })}

                  {liveMembers.length === 0 ? <div className="text-text-muted text-sm py-4 text-center">No hay fichajes abiertos para esta fecha.</div> : null}
                </div>
              </section>
