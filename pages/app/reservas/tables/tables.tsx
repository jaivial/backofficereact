        ...
        <AnimatePresence mode="wait" initial={false}>
          {isDayOpen ? (
            ...
            >
              ...
              <Modal open={editorOpen} title={editingTableId ? "Editar mesa" : "Nueva mesa"} onClose={() => setEditorOpen(false)} widthPx={980} className="bo-tableEditorModal" hideClose style={{ maxHeight: "85dvh" }}>
