...
export default function AnadirPage() {
  ...
  const data = (pageContext.data ?? { date: todayISO() }) as { date: string };
  ...
  const submit = useCallback(
    async (payload: unknown) => {
      ...
      try {
        ...
        const d = (payload as { reservation_date?: string })?.reservation_date || data.date;
  ...
  return (
    <section aria-label="Añadir reserva" className="bo-reservaAddPage" data-ui="anadir-page">
      <BookingEditor
        api={api}
        initial={initial}
        busy={busy}
