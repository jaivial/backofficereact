import { Coffee, GlassWater, Utensils, UtensilsCrossed, Wine } from "lucide-react";

import { Modal } from "../../../../ui/overlays/Modal";

export type CreateFoodType = "platos" | "bebidas" | "vinos" | "cafes" | "menus";
          ...
          <div className="bo-foodHubGrid" data-ui="food-create-picker-options">
            {OPTIONS.map(({ type, label, hint, icon: Icon }) => (
              <button
                ...
                data-testid={`food-create-picker-option-${type}`}
              >
