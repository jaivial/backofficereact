export type EntityType = "autonomo" | "sl" | "sl_new" | "sa";
...
const IRPF_BRACKETS: Array<{ from: number; to: number | null; rate: number }> = [
...
export function computeSimulation(gross: number, assumptions: TaxAssumptions, entityType: EntityType, firstProfitYear = false): TaxSimulation {
  ...
  const socialSecurity = entityType === "autonomo" && assumptions.includeSocialSecurity ? AUTONOMO_SS_MONTHLY * 12 : 0;
