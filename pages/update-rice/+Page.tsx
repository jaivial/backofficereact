    ...
    return (
      <div className="bo-publicPage" data-ui="book-rice">
        <div className="bo-publicPageCard" data-slot="update-rice-publicPageCard">
          ...
          <a href="/" className="bo-publicPageBtn bo-publicPageBtn--accent" data-testid="update-rice-page-back-home-link-2">Volver al inicio</a>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bo-publicPage" data-ui="book-rice">
        <div className="bo-publicPageCard" data-slot="update-rice-publicPageCard">
          ...
          <a href="/" className="bo-publicPageBtn bo-publicPageBtn--accent" data-testid="update-rice-page-no-form-back-link">Volver al inicio</a>
        </div>
      </div>
    );
  }
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="bo-publicPageForm" data-testid="update-rice-page-form">
          <div className="bo-publicPageFormGroup" data-slot="update-rice-publicPageFormGroup">
            ...
            <select
              ...
              required
              data-testid="update-rice-page-select"
            >
          ...
          <div className="bo-publicPageFormGroup" data-slot="update-rice-publicPageFormGroup">
            ...
            <input
              ...
              required
              data-testid="update-rice-page-servings-input"
            />
          </div>
          <button
            ...
            data-testid="update-rice-page-submit-button"
          >
            {loading ? <Loader2 size={18} className="bo-spin" /> : <Utensils size={18} />}
            Reservar Arroz
          </button>
        </form>
        <a href="/" className="bo-publicPageBtn bo-publicPageBtn--accent" data-testid="update-rice-page-back-link">Volver sin reservar</a>
      </div>
    </div>
  );
}
